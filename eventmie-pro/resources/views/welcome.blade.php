                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="lgx-heading">
                            <h2 class="heading"> @lang('eventmie-pro::em.featured_events')</h2>
                        </div>
                    </div>
                    <!-- Align button to the right -->
                    <div class="col-lg-8 text-lg-right">
                        <div class="section-btn-area">
                            <a class="lgx-btn lgx-btn-red" href="{{ route('eventmie.events_index') }}"> @lang('eventmie-pro::em.view_all_events')</a>
                        </div>
                    </div>
                </div>

                <div class="row">
                    <!-- Adjust column offset and size -->
...
<section>
    <div class="lgx-inner">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="lgx-heading lgx-heading-black">
